...
export default function Sidebar({ open, onClose }) {
  ...
  const displayName = user?.email?.split('@')[0] || 'ผู้ใช้'
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-50">
          ...
          <div>
            <p className="text-gray-900 font-bold text-sm leading-tight tracking-tight">HICHAO.CNX</p>
            <p className="text-gray-400 text-xs">Camera Rental</p>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-gray-50 mb-2">
            <div className="w-8 h-8 bg-brand-100 rounded-full flex items-center justify-center flex-shrink-0">
              <span className="text-brand-600 text-xs font-bold">{initials}</span>
            </div>
