      ...
      <div className="flex-1 min-w-0 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">ตั้งค่ากล้อง Ricoh ของร้าน · {recipes.length} recipes</p>
          </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2 ml-auto bg-white border border-gray-200 rounded-full px-3 py-1.5">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)}
              ...
              className="text-xs text-gray-600 outline-none bg-transparent w-28 placeholder-gray-300" />
          </div>
        </div>
