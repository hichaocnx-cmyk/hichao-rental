        ...
        <div className="xl:col-span-3 space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`xl:hidden flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-xl border transition-colors flex-shrink-0
                ${mobileCalOpen ? 'bg-brand-50 border-brand-200 text-brand-600' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}>
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
              </svg>
              {mobileCalOpen ? 'ซ่อน' : 'ปฏิทิน'}
              {selectedDay && <span className="w-1.5 h-1.5 rounded-full bg-brand-500 flex-shrink-0" />}
            </button>
