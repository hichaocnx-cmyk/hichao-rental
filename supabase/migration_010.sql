-- ============================================================
-- ⚠️⚠️ ไฟล์นี้ถูก "ยกเลิก" ไปแล้วโดย migration_012.sql (2 ส.ค. 2569)
--       ทางร้านเลือกให้ "จองทับได้ แค่เตือน" ไม่ใช่บล็อก
--       อย่ารันไฟล์นี้ซ้ำ เว้นแต่ตั้งใจจะกลับไปบล็อกเด็ดขาดอีกครั้ง
-- ============================================================
